        ...
        <div className="relative max-w-4xl mx-auto mt-12">
          ...
          <div className="relative bg-black/40 border border-white/10 p-6 rounded-xl">
            <div className="flex justify-center mb-6">
              <Image src="/images/logo_light.jpg" alt="derp.trade logo" width={200} height={100} className="rounded-lg" />
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative">
              ...
              <div className="relative flex flex-col md:flex-row md:justify-between items-start mb-16">
                ...
                <div className="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 w-8 h-8 rounded-full bg-[#AAFF00] border-4 border-[#0B100F] z-10"></div>
                <div className="flex flex-col items-start md:w-[45%] order-1 md:order-2">
